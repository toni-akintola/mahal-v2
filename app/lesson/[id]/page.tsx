          ...
          <GameCardContent className="p-8 text-center">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-blue-500">+{xpGained} XP</span>
              </div>
              {leveledUp && (
      ...
      {!showExercises && (
        <div className="max-w-6xl mx-auto px-4 py-8">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full h-full grid-cols-3 mb-8 bg-card border-4 border-border rounded-2xl p-3">
              <TabsTrigger
                value="guidebook"
                className="data-[state=active]:bg-blue-500 data-[state=active]:text-white rounded-xl font-bold text-lg py-4 px-6"
              >
                ...
                <GameCard>
                  ...
                  <GameCardContent className="space-y-4">
                    {lesson.guidebook.keyPhrases.map((phrase, index) => (
                      <div
                        key={index}
                        className="bg-muted/30 rounded-xl p-4 border-2 border-border"
                      >
                        <div className="flex justify-between items-start mb-2">
                          <span className="text-xl font-bold text-foreground">
                            {phrase.tagalog}
                          </span>
                          <SoundButton text={phrase.tagalog} />
                        </div>
                ...
                <GameCard>
                  ...
                  <GameCardContent className="space-y-3">
                    {lesson.guidebook.vocabulary.map((word, index) => (
                      <div
                        key={index}
                        className="bg-muted/30 rounded-xl p-3 border-2 border-border"
                      >
